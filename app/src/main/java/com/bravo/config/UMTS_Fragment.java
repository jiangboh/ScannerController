...
import com.bravo.parse_generate_xml.ex_config.ConfigUmts;
 ...
 */
public class UMTS_Fragment extends RevealAnimationBaseFragment {
    private String strControlIP;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_umts);
    }
    ...
    public void onResume() {
        ...
        ((RevealAnimationActivity)context).getSettingBtn().setOnClickListener(new RecordOnClick() {
            ...
            public void recordOnClick(View v, String strMsg) {
                ...
                super.recordOnClick(v, "Set Config UMTS Event");
            }
        });
    ...
    private void SetUMTS() {
        ConfigUmts configUmts = new ConfigUmts();
        configUmts.setMonitorIp(((IPEdit)contentView.findViewById(R.id.monitor_ip)).getIPAddtrss());
        ConfigReq configReq = new ConfigReq();
        configReq.setUmts(configUmts);
    ...
    private void SaveData() {
        SharedPreferences preferences = context.getSharedPreferences("umts_config",MODE_PRIVATE);
    ...
    private void LoadData() {
        SharedPreferences sp = context.getSharedPreferences("umts_config", MODE_PRIVATE);
