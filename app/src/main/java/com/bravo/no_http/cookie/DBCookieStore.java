 ...
 */
package com.bravo.no_http.cookie;

import android.content.Context;
import android.text.TextUtils;

import com.bravo.no_http.Logger;
import com.bravo.no_http.db.BaseDao;
import com.bravo.no_http.db.Where;
import com.bravo.no_http.db.Where.Options;
...
public class DBCookieStore implements CookieStore {
    ...
    public DBCookieStore(Context context) {
        ...
        // Delete temp cookie.
        Where where = new Where(CookieSQLHelper.EXPIRY, Where.Options.EQUAL, -1L);
